...
_SYMBOL_TO_MODULE = {
    ...
    "inspection_item_specs_from_line2dup_recipe": ".recipe_manager",
    "group_names_from_line2dup_recipe": ".recipe_manager",
    "output_labels_from_line2dup_recipe": ".recipe_manager",
    "clearable_roi_labels": ".recipe_manager",
