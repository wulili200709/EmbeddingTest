...
class Line2DupRecipe:
    ...
    template_angle_start: float = 0.0
    template_angle_end: float = 360.0
    template_angle_step: float = 10.0
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Line2DupRecipe":
        return cls(
            ...
            template_angle_start=float(data.get("template_angle_start", 0.0)),
            template_angle_end=float(data.get("template_angle_end", 360.0)),
            template_angle_step=float(data.get("template_angle_step", 10.0)),
