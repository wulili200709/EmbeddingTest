#!/usr/bin/env python3
"""
Batch runner for Python line2Dup-like pipeline, aligned to _third_party test.cpp logic.

Outputs:
  test/case0/result_line2dup_python/{1,2,3,4}.png
  test/case1/result_line2dup_python/result.png
  test/case2/result_line2dup_python/result.png
...
def run_case0(test_root: Path) -> CaseRun:
    ...
    out_dir = case_dir / "result_line2dup_python"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Python line2Dup-like pipeline for case0/1/2.")
...
def main() -> int:
    ...
    summary = {
        ...
        "pipeline": "python_line2dup_like",
        "runs": [r.__dict__ for r in runs],
    }
    dump_yaml(test_root / "line2dup_python" / "summary.yaml", summary)
    print(f"line2dup_python_batch done: {ok}/{len(runs)} cases succeeded.")
    print(f"summary: {test_root / 'line2dup_python' / 'summary.yaml'}")
