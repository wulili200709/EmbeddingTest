#!/usr/bin/env python3
"""
Interactive visual editor for shape template feature points.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Interactive point editor for shape template model.")
    ...
    parser.add_argument("--window", default="shape_template_editor", help="OpenCV window title.")
