#!/usr/bin/env python3
"""
Unified GUI workbench for shape template flow.
...
class TemplateWorkbenchApp(tk.Tk):
    def __init__(
        ...
        super().__init__()
        self.title("Shape Template Workbench")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Unified GUI workbench for shape template making/editing.")
