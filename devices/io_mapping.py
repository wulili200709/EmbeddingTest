        ...
        return cls.from_dict(
            {
                ...
                "do": {
                    ...
                    "light_cam3": {"channel": 6, "active_high": False},
                    "buzzer": {"channel": 5, "active_high": False},
                    "reserved_out_2": {"channel": 7, "active_high": False},
                },
            }
        )
    ...
    def _from_legacy_project_config(cls, data: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "do": {
                ...
                "light_cam3": cls._normalize_legacy_output(data.get("light_cam3"), default_channel=6),
