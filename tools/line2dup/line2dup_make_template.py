#!/usr/bin/env python3
"""
Build and save line2Dup-like templates into a reusable model package.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build line2Dup-like model from a template image.")
